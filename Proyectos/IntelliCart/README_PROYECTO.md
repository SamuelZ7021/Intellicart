...
**MiEcommerce** es una plataforma de e-commerce completa que permite a cualquier negocio vender productos online con una experiencia personalizada impulsada por Machine Learning.
...
|-----------|-------------|
| `PROYECTO_DOCUMENTACION.md` | Documentación completa del negocio |
| `plan_trabajo_detallado.md` | Plan de 14 semanas con tareas diarias |
| `ejemplos_codigo.md` | Código de ejemplo para todos los servicios |
| `proyecto_multi_lenguaje_guia.md` | Guía técnica y arquitectura |
...
**Hecho con ❤️ usando Java, Python y React**
