...
//#region node_modules/@opentelemetry/context-zone-peer-dep/build/esm/util.js
/**
...
//#endregion
//#region node_modules/@opentelemetry/context-zone-peer-dep/build/esm/ZoneContextManager.js
...
var ZoneContextManager = class {
	...
	*/
	_bindListener(context, obj) {
		const target = obj;
		if (target.__ot_listeners !== void 0) return obj;
	...
	*/
	_createZone(zoneName, context) {
		return Zone.current.fork({
			name: zoneName,
			properties: { [ZONE_CONTEXT_KEY]: context }
		});
	}
	/**
	...
	*/
	_patchAddEventListener(target, original, context) {
		...
		return function(event, listener, opts) {
			if (target.__ot_listeners === void 0) target.__ot_listeners = {};
	...
	*/
	_patchRemoveEventListener(target, original) {
		return function(event, listener) {
			if (target.__ot_listeners === void 0 || target.__ot_listeners[event] === void 0) return original.call(this, event, listener);
	...
	*/
	bind(context, target) {
		...
		else if (isListenerObject(target)) this._bindListener(context, target);
		return target;
	}
	/**
...
//# sourceMappingURL=@opentelemetry_context-zone.js.map